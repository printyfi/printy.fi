...
const useStyles = makeStyles((theme) => ({
  ...
  buttonOverride: {
    width: '100%',
    color: 'rgb(52, 215, 58)',
    background: 'rgb(122, 122, 122, 0.72)',
    fontWeight: '700',
    '&:hover': {
...
const getLocalToggles = () => {
  ...
  try {
    const localToggleString = localStorage.getItem('printy-pairsToggle-v1')
...
const EnhancedTableToolbar = (props) => {
  ...
  const onToggle = (event) => {
    ...
    try {
      localStorage.setItem('printy-pairsToggle-v1', JSON.stringify(localToggles))
    } catch (ex) {
      console.log(ex)
    }
  }
            ...
            <div className={classes.filterContainer}>
              ...
              <Grid container spacing={0}>
                ...
                <Grid item lg={3} className={classes.alignContentRight}>
                  <Switch color="primary" checked={toggleActive} name={'toggleActive'} onChange={onToggle} />
                </Grid>
              </Grid>
              ...
              <Grid container spacing={0}>
                ...
                <Grid item lg={3} className={classes.alignContentRight}>
                  <Switch color="primary" checked={toggleActiveGauge} name={'toggleActiveGauge'} onChange={onToggle} />
                </Grid>
              </Grid>
              ...
              <Grid container spacing={0}>
                ...
                <Grid item lg={3} className={classes.alignContentRight}>
                  <Switch color="primary" checked={toggleStable} name={'toggleStable'} onChange={onToggle} />
                </Grid>
              </Grid>
              ...
              <Grid container spacing={0}>
                ...
                <Grid item lg={3} className={classes.alignContentRight}>
                  <Switch color="primary" checked={toggleVariable} name={'toggleVariable'} onChange={onToggle} />
                </Grid>
              </Grid>
            </div>
          </Fade>
