...
function MyVotesIcon(props) {
  ...
  return (
    <SvgIcon viewBox="0 0 48 48" strokeWidth="2.5" className={className}>
      <g strokeWidth="2.5" transform="translate(0, 0)">
        <path
          data-cap="butt"
          data-color="color-2"
          fill="none"
          ...
          strokeWidth="2.5"
          strokeMiterlimit="10"
          d="M19,24.153V30L8.454,32.812 C5.828,33.513,4,35.891,4,38.61V46h40v-7.39c0-2.718-1.828-5.097-4.454-5.797L29,30v-5.847"
        ...
        <path
          ...
          strokeMiterlimit="10"
          d="M24,26L24,26 c-5.523,0-10-6.477-10-12v-2c0-5.523,4.477-10,10-10h0c5.523,0,10,4.477,10,10v2C34,19.523,29.523,26,24,26z"
          strokeLinejoin="miter"
        ></path>
      </g>
    </SvgIcon>
              ...
              <Grid item lg={9} md={9} sm={9} xs={9} className={classes.itemContent}>
                ...
                <div className={classes.inline}>
                  <Typography className={classes.value}>
                    {formatCurrency(veToken && veToken.vestingInfo ? veToken.vestingInfo.votePower : 0)}
                  </Typography>
          ...
          <Paper elevation={0} className={classes.itemWrapGrid}>
            <Grid container spacing={0}>
              ...
              <Grid item lg={9} md={9} sm={9} xs={9} className={classes.itemContent}>
                ...
                <div className={classes.inline}>
                  <Typography className={classes.value}>
                    {formatCurrency(veToken && veToken.vestingInfo ? veToken.vestingInfo.totalSupply : 0)}
                  </Typography>
                  <Typography className={classes.valueSymbol}>{veToken ? veToken.symbol : ''}</Typography>
                </div>
              </Grid>
