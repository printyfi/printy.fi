    ...
    return (
      <Paper className={classes.tokenContainer}>
        <div className={classes.inline}>
          ...
          <div>
            <Typography className={classes.tokenName} variant="h2">
              {token.name}
            </Typography>
        ...
        <div className={classes.whitelistStatus}>
          <div className={classes.whitelistContainer}>
            <div>
              <Typography className={classes.listingFee} color="textSecondary">
                Whitelist Status
              </Typography>
              {token.isWhitelisted && <Typography className={classes.isWhitelist}>{'Whitelisted'}</Typography>}
              {!token.isWhitelisted && <Typography className={classes.notWhitelist}>{'Not Whitelisted'}</Typography>}
            </div>
            {!token.isWhitelisted && (
              <Tooltip title="Listing fee either needs to be locked in your veToken NFT or be paid and burnt on list">
                <div>
                  ...
                  <Typography className={classes.listingFee}>
                    {formatCurrency(token.listingFee)} {veToken?.symbol}
                  </Typography>
                </div>
              </Tooltip>
            )}
