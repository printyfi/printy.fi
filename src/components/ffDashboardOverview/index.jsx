  ...
  const calculateTotalBalance = (ass) => {
    ...
    for (let i = 0; i < ass.length; i++) {
      ...
      if (asset && asset.gauge) {
        ...
        let tot = BigNumber(asset.balance)
          .plus(pooledBalance)
          .plus(stakedBalance)
          .plus(convexBalance)
          .times(asset.price)
          ...
          <Paper elevation={0} className={classes.itemWrapGrid}>
            <Grid container spacing={0}>
              ...
              <Grid item lg={9} md={9} sm={9} xs={9} className={classes.itemContent}>
                <Typography className={classes.title}>PRINT Balance:</Typography>
              ...
              <Grid item lg={9} md={9} sm={9} xs={9} className={classes.itemContent}>
                ...
                <div className={classes.inline}>
                  <Typography className={classes.value}>
                    {formatCurrency(veToken && veToken.vestingInfo ? veToken.vestingInfo.lockValue : 0)}
                  </Typography>
