              ...
              <Grid item lg={12} md={12} sm={12} xs={12}>
                <Grid container spacing={4}>
                  <Grid item lg={3} md={6} sm={12} xs={12}>
                    ...
                    <Paper elevation={0} onClick={() => router.push('/liquidity')} className={classes.viewCollateral}>
                      View
                    </Paper>
                    <Overview />
                  </Grid>
                  ...
                  <Grid item lg={3} md={6} sm={12} xs={12}>
                    ...
                    <Paper elevation={0} onClick={() => router.push('/vest')} className={classes.viewVesting}>
                      View
                    </Paper>
                    <Overview />
                  </Grid>
                  ...
                  <Grid item lg={3} md={6} sm={12} xs={12}>
                    ...
                    <Paper elevation={0} onClick={() => router.push('/vote')} className={classes.viewVoting}>
                      View
                    </Paper>
                    <VoteOverview />
                  </Grid>
                  ...
                  <Grid item lg={3} md={6} sm={12} xs={12}>
                    <Typography className={classes.mainHeadingRewards} variant="h1">
                      Rewards
                    </Typography>
                    <ClaimAll />
                  </Grid>
