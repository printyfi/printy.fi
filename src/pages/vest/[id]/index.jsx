      ...
      {account && account.address ? (
        ...
        <Paper className={classes.notConnectedContent}>
          ...
          <Typography className={classes.mainDescNC} variant="body2">
            Lock your Solid to earn rewards and governance rights. Each locked position is created and represented as an
            NFT, meaning you can hold multiple locked positions.
          </Typography>
